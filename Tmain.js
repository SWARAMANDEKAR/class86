...
function sort(){
    ...
    console.log(name_of_the_student_array);
    var dispalysortingarray=[];
    var lenght_of_name_of_students_array = name_of_the_student_array.length;
    console.log(lenght_of_name_of_students_array);
    for (var k = 0; k < lenght_of_name_of_students_array; k++) 
    {
        dispalysortingarray.push("<h4>NAME - "+ name_of_the_student_array[k] + "</h4>");
        console.log(dispalysortingarray);
        

    }
    var remove_commas = dispalysortingarray.join(" ");
    console.log(remove_commas);
    document.getElementById("display_name_without_commas").innerHTML = remove_commas;
